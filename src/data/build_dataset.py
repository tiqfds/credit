...
def generate_dataset(n_customers, n_terminals, nb_days, start_date, r=5):
    ...
    print("Time to generate dataset: {0:.2}s".format(time.time()-total_time))
...
def add_frauds(customer_profiles_table, terminal_profiles_table, transactions_df):
    ...
    print("Time to generate frauds: {0:.2}s".format(time.time()-start_time))
...
if __name__ == '__main__':
    ...
    terminal_radius_4 = get_list_terminals_within_radius(customer_profiles_table.iloc[4], x_y_terminals=x_y_terminals, r=50)
    ...
    (customer_profiles_table, terminal_profiles_table, transactions_df)= generate_dataset(n_customers = 50000,
                                                                                          n_terminals = 100000,
                                                                                          nb_days=365,
    ...
    DIR_OUTPUT = "./data/raw/simulated-data-raw/"
